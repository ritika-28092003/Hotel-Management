...
from django.views.generic import TemplateView, UpdateView, DetailView, CreateView, DeleteView, ListView, View
...
class UserLogin(LoginView):
    ...
    def get_success_url(self):
        if self.request.user.is_superuser:
            return reverse_lazy('myadmin:myadmin')  # Redirect superusers to admin page
        else:
            return reverse_lazy('hotel:index')
